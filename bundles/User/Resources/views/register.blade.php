...
@section('content')
    <form class="row g-3 mt-3" action="{{ route('register_page') }}" method="POST">
        ...
        @endif
        <button type="submit" class="btn btn-primary">{{ __('buttons.joinNow') }}</button>
    </form>



    <!-- Modal -->
    <div class="modal fade" id="termsOfServiceModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab asperiores aspernatur autem dicta dolores eum ex explicabo id, ipsam libero magni molestias nesciunt obcaecati praesentium provident quod suscipit totam veritatis.
                    TODO: add
                </div>
